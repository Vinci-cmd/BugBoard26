...
const Dashboard = () => {
    ...
    // Chiama fetchIssues ogni volta che i filtri cambiano o al primo avvio
    useEffect(() => {
        fetchIssues();
    ...
    // --- STILI "UNIVERSITY" AGGIORNATI ---
    const styles = {
        pageWrapper: {
            backgroundColor: '#f4f6f9', // Sfondo pagina leggermente grigio per far risaltare le card
            minHeight: 'calc(100vh - 80px)', // Altezza minima meno la navbar
            padding: '2rem 1rem'
        },
        container: { 
            maxWidth: '1000px', // Leggermente più largo per respirare meglio
            margin: '0 auto',
        ...
        pageTitle: {
            margin: 0,
            fontSize: '2rem',
            color: '#2c3e50', // Blu istituzionale
        ...
        filterBar: { 
            ...
            marginBottom: '2rem', 
            padding: '1.5rem', 
            backgroundColor: '#ffffff', // Sfondo bianco per il pannello filtri
            borderRadius: '6px',
            boxShadow: '0 2px 8px rgba(0,0,0,0.05)', // Ombra leggera
            border: '1px solid #e0e0e0',
            flexWrap: 'wrap' // Per mobile friendly
        },
        label: {
            display: 'block',
            fontSize: '0.8rem',
